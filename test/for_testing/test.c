...
LIB_test_C_API 
bool MW_CALL_CONV mlfTest(int nargout, mxArray** dataZtj, mxArray** dataHtj, mxArray** 
                          sizeZtj, mxArray** sizeHtj, mxArray* filename)
{
    return mclMlfFeval(_mcr_inst, "test", nargout, 4, 1, dataZtj, dataHtj, sizeZtj, sizeHtj, filename);
}
